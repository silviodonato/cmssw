...
# with command line options: TTbar_Tauola_8TeV_cfi --conditions auto:run1_mc --fast -n 10 --eventcontent FEVTDEBUGHLT,DQM --relval 100000,1000 -s GEN,SIM,RECO,EI,HLT:@fake,VALIDATION --datatier GEN-SIM-DIGI-RECO,DQMIO -n 1 --fileout file:test_9_a_1.root --no_exec --python_filename=test_9_a_1.py
...
process.load('HLTrigger.Configuration.HLT_Fake_Famos_cff')
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('TTbar_Tauola_8TeV_cfi nevts:1'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:test_9_a_1.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:test_9_a_1_inDQM.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
