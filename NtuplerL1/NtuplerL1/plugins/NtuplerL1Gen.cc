...
//    }
    ...
    if(abs(it->pdgId())==11 && abs(it->mother()->pdgId())==24 ){
        if (!W_found){
            W_found=true;
            W = (gPart) it->mother();
            cout<< "*";
    ...
    if(abs(it->pdgId())==13 && abs(it->mother()->pdgId())==24 ){
        if (!W_found){
            W_found=true;
            W = (gPart) it->mother();
            cout<< "*";
    ...
    if( (abs(it->pdgId())==12 || abs(it->pdgId())==14 || abs(it->pdgId())==16)&& abs(it->mother()->pdgId())==24 ){
        if (!W_found){
            W_found=true;
            W = (gPart) it->mother();
            cout<< "*";
