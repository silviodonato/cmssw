...
process.l1extraParticles = cms.EDProducer("L1ExtraParticlesProd",
     muonSource = cms.InputTag("caloStage1LegacyFormatDigis"), #gtDigis or simGtDigis
     etTotalSource = cms.InputTag("caloStage1LegacyFormatDigis"), #gctDigis
...
process.p1 = cms.Path(
    process.L1TCaloStage1_PPFromRaw + process.l1extraParticles + process.n
    )
