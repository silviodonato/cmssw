...
def customiseRun3BTagRegionalTracks_Replacement_global_globalCalo(process):
    ...
    # process.hltVerticesPF = process.hltVerticesPF.clone(
    #     TrackLabel = cms.InputTag("hltPFMuonMerging"),
    # )
    #
    # process.hltVerticesPFSelector = process.hltVerticesPFSelector.clone(
    ...
    # )
    #
    # process.hltVerticesPFFilter = process.hltVerticesPFFilter.clone(
    ...
    process.hltImpactParameterTagInfos = process.hltImpactParameterTagInfos.clone(
        ...
        # primaryVertex = cms.InputTag("hltVerticesL3Filter","WithBS"),
    ...
    # process.HLTAK4PFCorrectorProducersSequence = cms.Sequence(
    ...
    # )
    #
    # process.HLTAK4PFJetsCorrectionSequence = cms.Sequence(
    #     process.hltFixedGridRhoFastjetAll+
    #     process.HLTAK4PFCorrectorProducersSequence+
    #     process.hltAK4PFJetsCorrected+
    #     process.hltAK4PFJetsLooseIDCorrected+
    #     process.hltAK4PFJetsTightIDCorrected
    # )
    #
    # process.HLTAK4PFJetsSequence = cms.Sequence(
    #     process.HLTPreAK4PFJetsRecoSequence+
    #     process.HLTAK4PFJetsReconstructionSequence+
