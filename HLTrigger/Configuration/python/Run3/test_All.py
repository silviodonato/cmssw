...
###### process = BTV_roiCalo_roiPF(process) ## Calo b-tagging: new regional calo b-tagging [new sequence] ## PF b-tagging: new regional PF b-tagging [new sequence] 
### Error: Missing hltMergedTracksForBTag (from hltFastPixelBLifetimeL3Associator in MC_CaloBTagDeepCSV_v8)
###### process = BTV_roiCalo_globalPF(process) ## Calo b-tagging: new regional calo b-tagging [new sequence] ## PF b-tagging: new global PF b-tagging 
### Error: Missing hltMergedTracksForBTag (from hltFastPixelBLifetimeL3Associator in MC_CaloBTagDeepCSV_v8)
