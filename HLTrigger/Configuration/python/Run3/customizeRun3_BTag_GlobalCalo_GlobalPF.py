...
def customizeRun3_BTag_GlobalCalo_GlobalPF(process, addDeepJetPaths = True):
    ...
    ########################################
    # new CALO and global TRK for that
    ...
    process.hltVerticesL3Selector = process.hltVerticesPFSelector.clone(
        filterParams = cms.PSet(
            maxRho = cms.double(2.0),
            maxZ = cms.double(24.0),
            minNdof = cms.double(4.0),
    ...
    process.hltVerticesL3Filter = process.hltVerticesPFFilter.clone(
        src = cms.InputTag("hltVerticesL3Selector")
    )
    ...
    process.hltImpactParameterTagInfos = process.hltImpactParameterTagInfos.clone(
        jetTracks = cms.InputTag("hltFastPixelBLifetimeL3Associator"),
        primaryVertex = cms.InputTag("hltVerticesL3Filter"),
    )

    process.hltInclusiveVertexFinder = process.hltInclusiveVertexFinder.clone(
        primaryVertices = cms.InputTag("hltVerticesL3Filter"),
        tracks = cms.InputTag("hltMergedTracks"),
    )

    process.hltInclusiveSecondaryVertices = process.hltInclusiveSecondaryVertices.clone(
    ...
    process.hltInclusiveMergedVertices = process.hltInclusiveMergedVertices.clone(
        secondaryVertices = cms.InputTag("hltTrackVertexArbitrator")
    )

    process.hltInclusiveSecondaryVertexFinderTagInfos = process.hltInclusiveSecondaryVertexFinderTagInfos.clone(
        extSVCollection = cms.InputTag("hltInclusiveMergedVertices"),
        trackIPTagInfos = cms.InputTag("hltImpactParameterTagInfos"),
    )

    process.hltDeepCombinedSecondaryVertexBJetTagsInfosCalo = process.hltDeepCombinedSecondaryVertexBJetTagsInfosCalo.clone(
        svTagInfos = cms.InputTag("hltInclusiveSecondaryVertexFinderTagInfos")
    )

    process.hltDeepCombinedSecondaryVertexBJetTagsCalo = process.hltDeepCombinedSecondaryVertexBJetTagsCalo.clone(
        src = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsInfosCalo"),
    )

    process.HLTBtagDeepCSVSequenceL3 = cms.Sequence(
    ...
    # )
    #
    process.hltBTagCaloDeepCSVp17Double = process.hltBTagCaloDeepCSVp17Double.clone(
    ...
    process.hltBTagCaloDeepCSV10p01Single = process.hltBTagCaloDeepCSV10p01Single.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    ...
    process.hltBTagCaloDeepCSV1p56Single = process.hltBTagCaloDeepCSV1p56Single.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    ...
    process.hltBTagCaloDeepCSV4p50Single = process.hltBTagCaloDeepCSV4p50Single.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
        MinTag = cms.double(0.24),
    )
    ...
    process.HLT_Ele15_IsoVVVL_PFHT450_CaloBTagDeepCSV_4p5_v8 = cms.Path(
        ...
        process.HLTBtagDeepCSVSequenceL3+
        process.hltBTagCaloDeepCSV4p50Single+
    ...
    process.hltBTagCaloDeepCSV0p71Single6Jets80 = process.hltBTagCaloDeepCSV0p71Single6Jets80.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    ...
    process.HLT_DoublePFJets100_CaloBTagDeepCSV_p71_v2 = cms.Path(
        ...
        process.HLTBtagDeepCSVSequenceL3+
        process.hltBTagCaloDeepCSV0p71Single6Jets80+
    ...
    process.hltBTagCaloDeepCSV0p71Double6Jets80 = process.hltBTagCaloDeepCSV0p71Double6Jets80.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    )
    ...
    process.HLT_DoublePFJets116MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_v2 = cms.Path(
        ...
        process.hltSelector6CentralJetsL1FastJet+
        process.HLTBtagDeepCSVSequenceL3+
        process.hltBTagCaloDeepCSV0p71Double6Jets80+
    ...
    process.hltBTagCaloDeepCSV0p71Single8Jets30 = process.hltBTagCaloDeepCSV0p71Single8Jets30.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    )
    ...
    process.HLT_DoublePFJets40_CaloBTagDeepCSV_p71_v2 = cms.Path(
        ...
        process.HLTBtagDeepCSVSequenceL3+
        process.hltBTagCaloDeepCSV0p71Single8Jets30+
    ...
    process.hltBTagCaloDeepCSV0p71Double8Jets30 = process.hltBTagCaloDeepCSV0p71Double8Jets30.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    )
    ...
    process.HLT_Mu12_DoublePFJets40MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_v2 = cms.Path(
        ...
        process.hltDoubleCaloBJets30eta2p3+
        process.HLTBtagDeepCSVSequenceL3+
        process.hltBTagCaloDeepCSV0p71Double8Jets30+
    ...
    process.hltBTagCaloDeepCSV3p07Single = process.hltBTagCaloDeepCSV3p07Single.clone(
        JetTags = cms.InputTag("hltDeepCombinedSecondaryVertexBJetTagsCalo","probb"),
    )
    ...
    process.HLT_PFMET110_PFMHT110_IDTight_CaloBTagDeepCSV_3p1_v8 = cms.Path(
        ...
        process.hltMHT80+
        process.HLTBtagDeepCSVSequenceL3+
        process.hltBTagCaloDeepCSV3p07Single+
        process.HLTAK4PFJetsSequence+
